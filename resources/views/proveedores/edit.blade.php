            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('proveedores.update', $proveedor->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required type="text" class="form-control" name="nombre"
                                                        placeholder="Por ejemplo, Acme Corp" autocomplete="off"
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select required class="form-control" id="tipo_documento"
                                                        ...
                                                        <option value="TI" {{ $proveedor->tipo_documento == 'TI' ? 'selected' : '' }}>TI</option>
                                                    </select>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required type="email" class="form-control" name="email"
                                                        placeholder="Por ejemplo, contacto@acme.com" autocomplete="off"
                                ...
                                <input type="hidden" class="form-control" name="estado" value="{{ $proveedor->estado }}">
                            </div>
