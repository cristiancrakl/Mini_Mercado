            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('ordenCompras.update', $ordenCompra->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4 ">
                                                    ...
                                                    <input type="text" class="form-control" name="total"
                                                        value="{{ $ordenCompra->total }}" placeholder="Por ejemplo, 600"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <input type="hidden" class="form-control" name="estado" value="{{ $ordenCompra->estado }}">
                            </div>
